...
| **Scientific** | NumPy, Matplotlib, SymPy, Pandas |
...
| :--- | :--- | :--- | :--- |
| **E-Commerce API Platform** | FastAPI + PostgreSQL + Redis + Docker | 🔵 In Progress | Production-grade marketplace backend with payment integration |
